	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<!-- template sections -->
				...
				<header class="page_header header_white toggler_xs_right section_padding_20" style="position:fixed;width:100%;top:0;height: whatever ">
				...
				<div class="container-fluid" style="background: #00000">
					<div class="row">
						<div class="col-md-9 col-sm-8 text-center text-sm-left">
							<a href="../admin-map.php" class="theme_button color4 margin_0">Validate Locations</a>
						</div>
